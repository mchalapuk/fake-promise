  ...
  describe("FakePromise", function() {
    ...
    describe("when after .resolve() without result", function() {
      ...
      it("calling .then(callback) calls the callback immediately", function() {
        ...
        callback = sinon.spy();
        testedPromise.then(callback);
        return callback.should.have.callCount(1).and.have.been.calledWith();
      });
    ...
    describe("when after .then(onfulfilled) specified", function() {
      ...
      it(".setResult(undefined).resolve() doesn't throw", function() {
        (testedPromise.setResult(void 0)).resolve();
        return void 0;
      });
    ...
    return describe("when after .catch(returnResolvedPromise).then(onrejected) specified", function() {
      var thenCallback;
      thenCallback = null;
      beforeEach(function() {
        var resultPromise;
