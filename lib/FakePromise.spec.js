...
(function() {
  ...
  describe("FakePromise", function() {
    ...
    [null, void 0].forEach(function(arg) {
      return it("calling .setError(" + arg + ") throws", function() {
        return should(function() {
          return testedPromise.setError(arg);
        })["throw"]("error must not be undefined nor null");
      });
    });
    ['reject', 'rejectOne'].forEach(function(methodName) {
      return it("calling ." + methodName + "(null) throws", function() {
        return should(function() {
    ...
    return describe("when after calling .setResult(undefined)", function() {
      ...
      it("calling .resolveOne() does not throw", function() {
        testedPromise.resolveOne().resolveOne();
        return testedPromise.then(function(result) {
