...
(function() {
  ...
  LoggingProxyHandler = (function() {
    ...
    LoggingProxyHandler.prototype.construct = function(Target, args) {
    ...
    LoggingProxyHandler.prototype.apply = function(target, thisArg, args) {
      var e, result;
    ...
    LoggingProxyHandler.prototype.log = function(target, operation, args) {
      return console.log("" + (this.printIndent()) + (target.id ? ("#" + target.id + " ").gray : "") + operation + " " + (args ? args.gray : ""));
    };

    LoggingProxyHandler.prototype.printIndent = function() {
